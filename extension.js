...
function activate(context) {
    var hovers = vscode.languages.registerHoverProvider("html", {
        provideHover(document, position, token) {
            ...
            for (var snippet in filtersArr) {
                if (
                    filtersArr[snippet].prefix === word ||
                    filtersArr[snippet].hover === word
                ) {
    ...
    var filters = vscode.languages.registerCompletionItemProvider(
        "html",
        {
            provideCompletionItems(document, position, token) {
                ...
                for (var snippet in filtersArr) {
                    if (typeof filtersArr[snippet].text !== "undefined") {
                        var description =
                            typeof filtersArr[snippet].description ===
                            "undefined"
                                ? ""
                                : filtersArr[snippet].description
                        var example =
                            typeof filtersArr[snippet].example === "undefined"
                                ? ""
    ...
    var loopField = vscode.languages.registerCompletionItemProvider(
        "html",
        {
            provideCompletionItems(document, position, token) {
                var start = new vscode.Position(position.line, 0)
                ...
                for (var snippet in loopArr) {
                    var description =
                        typeof loopArr[snippet].description === "undefined"
                            ? ""
                            : loopArr[snippet].description
                    var item = new vscode.CompletionItem(snippet)
    ...
    var tests = vscode.languages.registerCompletionItemProvider(
        "html",
        {
            provideCompletionItems(document, position, token) {
                var start = new vscode.Position(position.line, 0)
                ...
                if (
                    !(text.substring(text.length - 3) === "is ") ||
                    text.substring(text.length - 3) === "not "
                ) {
                    return completionItems
                }
                ...
                for (var snippet in testsArr) {
                    var description =
                        typeof testsArr[snippet].description === "undefined"
                            ? ""
                            : testsArr[snippet].description
                    var item = new vscode.CompletionItem(snippet)
